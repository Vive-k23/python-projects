...
using(department_id) group by department_id having count(a.department_id) >=1;
...
select a.employee_id  first_name , last_name , department_name from employees a left join departments b using(department_id); 
