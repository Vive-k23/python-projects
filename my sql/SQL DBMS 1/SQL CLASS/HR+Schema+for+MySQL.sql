...
-- List the employee details working for department 80

select * from employees where department_id=80;

-- List employees who earn salary more than 10000
select * from employees where salary>10000;
-- List employees who do not have commission
select * from employees where commission_pct is null;
-- List employees who earn salary in the range of 10000 to 15000
select * from employees where salary between 10000 and 15000;

-- List employees working for department 30 and 60
select * from employees where department_id =30 or department_id=60 or department_id=80;
select * from employees where department_id in (30,60,80);

select *from employees where department_id=50 and job_id<> ' ST_CLERK';
select * from employees where department_id=50 and job_id not  in ('ST_CLERK', 'SH_CLERK');
